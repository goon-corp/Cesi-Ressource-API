...
public interface ICommentService
{
    ...
    Task<Result<PagedResult<CommentInfoDto>>> GetCommentsByRessourceAsync(Guid ressourceId, PagedQueryParameters paging, CancellationToken cancellationToken = default);
