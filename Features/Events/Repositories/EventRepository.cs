...
public class EventRepository : BaseRepository<Event>, IEventRepository
{
    ...
    public async Task<PaginatedList<EventMemberDto>> GetEventMembersAsync(Guid eventId, EventMemberQuery query, CancellationToken cancellationToken = default)
    {
        var membersQuery = _context.Set<Event>()
        ...
        return new PaginatedList<EventMemberDto>(members, query.page, query.size, totalCount);
    }
